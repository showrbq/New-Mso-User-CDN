/*! WOW-v0.1.9 | MIT License | By Matthieu Aussaguel */
...
/*! Custom | GPL-3.0 License | By Moedog */
$(document).on("click",".start",function(){layer.open({type:1,area:["400px","300px"],title:"Application Form",resize:false,scrollbar:false,content:'<iframe src="'+$(".btn.start").attr("data-form")+'" width="100%" height="260px" frameborder="0"></iframe>'})});$(document).on("click",".try",function(){layer.open({type:1,area:["400px","300px"],title:"Application Form",resize:false,scrollbar:false,content:'<iframe src="'+$(".btn.try").attr("data-form")+'" width="100%" height="260px" frameborder="0"></iframe>'})});$(document).on("click",".about",function(){layer.open({type:1,area:["300px","350px"],title:"About",resize:false,scrollbar:false,content:'<div style="text-align:center;margin-top:30px"><img src="'+$('meta[name="cdn"]').attr("content")+'/static/images/about.png" width="auto" height="180px"><div style="margin-top:25px;color:#555">© '+new Date().getFullYear()+' <a href="https://prprpr.love" target="_blank" rel="nofollow" style="color:#ff8e3a">Moedog</a> . All Rights Received.</div></div>'})});if($("body").attr("data-go")=="key"){layer.open({type:1,area:["400px","300px"],title:"Application Form",resize:false,scrollbar:false,content:'<iframe src="'+$(".btn.start").attr("data-form")+'" width="100%" height="260px" frameborder="0"></iframe>'})}else{if($("body").attr("data-go")=="code"){layer.open({type:1,area:["400px","300px"],title:"Application Form",resize:false,scrollbar:false,content:'<iframe src="'+$(".btn.try").attr("data-form")+'" width="100%" height="260px" frameborder="0"></iframe>'})}}if($("div").hasClass("aplayer-footer")){$.ajax({url:$("#ap-footer").attr("data-json"),success:function(e){var a=new APlayer({element:document.getElementById("ap-footer"),autoplay:false,fixed:true,loop:"all",order:"random",listFolded:true,showlrc:3,theme:"#e6d0b2",listmaxheight:"200px",music:eval(e)});window.aplayers||(window.aplayers=[]),window.aplayers.push(a)}})}jQuery(function(a){new WOW().init();a(window).load(function(){a(".main-slider").addClass("animate-in");a(".preloader").remove()})});